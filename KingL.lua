...
Frame.Name = "POPUPZAZA007"
Frame.Parent = game:GetService("Players").LocalPlayer.PlayerGui.Popup
...
repeat wait() until game:GetService("Players").LocalPlayer.PlayerGui.Stats.Enabled == true
end
...
local library = {
	WorkspaceName = "NormalHub_Premium_KingLegacy",
	flags = {},
	signals = {},
	objects = {},
	elements = {},
...
function library:CreateWindow(options, ...)
	...
	function windowFunctions:CreateTab(options, ...)
		...
		library.signals[1 + #library.signals] = newTab.MouseButton1Click:Connect(gotot)
		if windowFunctions.tabCount == 1 then
...
Name = "Discord : discord.gg/yfWvshfRdb"
})
